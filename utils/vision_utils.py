...
class VisualManager:
    def __init__(self, model, processor, is_video):
        ...
        self.gen_config = {'eos_token_id': self.eos_token_id, 'repetition_penalty': self.repetition_penalty}
    ...
    def get_output_text(self, messages, vision_tensors, max_new_tokens=None, greedy=False):
    ...
    def init_generation_config(self, max_new_tokens=None, repetition_penalty=None, temperature=None):
